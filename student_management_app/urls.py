...
urlpatterns = [
    ...
    path('staff_add_result2/', StaffViews.staff_add_result2, name="staff_add_result2"),
    path('staff_add_result3/', StaffViews.staff_add_result3, name="staff_add_result3"),
    path('take_quiz/<id>/' , StaffViews.take_quiz , name="take_quiz"),
    #path('api/<id>/data' , StaffViews.api_question1),
    path('take_quiz/<id>/data/' , StaffViews.api_question),
    path('start_exam_view/<id>/' , StaffViews.start_exam_view),
    path('start_quize/' , StaffViews.start_quize,name="start_quize"),
    path('start_result/' , StaffViews.start_result,name="start_result"),
    path('start_result/saveans/' , StaffViews.saveans,name="saveans"),
    path('calculate-marks', StaffViews.calculate_marks_view,name='calculate-marks'),
